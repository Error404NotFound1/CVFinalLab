...
\usepackage[UTF8]{ctex}                     % 支持中文显示，xelatex 自动选择系统字体
...
\newtcblisting{codeblock}[1]{
    ...
    listing options={
        style=elegant,
        language=Python,
        basicstyle=\ttfamily\fontsize{8.5pt}{9.2pt}\selectfont,
        aboveskip=0pt,
        belowskip=0pt,
        numbers=left,
        numbersep=8pt,
...
% 生成有书签的 pdf 及其生成方式。适配 xelatex（推荐）和 pdflatex
\usepackage{hyperref}
\hypersetup{
    unicode,
    pdfborder={0 0 0},
